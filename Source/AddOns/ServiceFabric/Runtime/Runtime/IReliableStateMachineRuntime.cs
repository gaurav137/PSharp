//-----------------------------------------------------------------------
// <copyright file="IReliableStateMachineRuntime.cs">
...
{
    /// <summary>
    /// Interface of a runtime for executing reliable state-machines.
    /// </summary>
    public interface IReliableStateMachineRuntime
    {
        /// <summary>
        ...
        HashSet<MachineId> GetCreatedMachineIds();
